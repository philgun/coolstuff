...
model sCO2PBRig
  ...
  // *********************PB Params
  parameter SI.Power P_net = 42072522.11;
  parameter SI.Temperature T_in_ref_blk = 1106.75;
  parameter SI.Temperature T_low = from_degC(41) "Cooler outlet temperature at design point";
  parameter SI.Temperature T_high = 1006.75 "Turbine inlet temperature at design point";
  parameter SI.Temperature blk_T_amb_des = from_degC(39);
  parameter SI.AbsolutePressure p_high = 24951598.17 "high pressure of the cycle";
  ...
  // ********************* Environment
  parameter SI.Temperature T_amb_input = 311.32;
  parameter SI.Temperature T_HTF_in = 1098.95;
  parameter Real load = 0.66;
