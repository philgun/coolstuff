...
extern void sCO2PBRig_eqFunction_1188(DATA* data, threadData_t *threadData);
...
extern void sCO2PBRig_eqFunction_1219(DATA* data, threadData_t *threadData);
extern void sCO2PBRig_eqFunction_1218(DATA* data, threadData_t *threadData);
extern void sCO2PBRig_eqFunction_1217(DATA* data, threadData_t *threadData);
...
int sCO2PBRig_functionAlgebraics(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
  ...
  sCO2PBRig_function_savePreSynchronous(data, threadData);
