...
void sCO2PBRig_eqFunction_570(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  jacobian->tmpVars[3] /* powerBlock.mainCompressor.m_des.$pDERLSJac49.dummyVarLSJac49 JACOBIAN_DIFF_VAR */ = (jacobian->seedVars[0] /* powerBlock.LTR.m_turb_des.SeedLSJac49 SEED_VAR */) * (data->simulationInfo->realParameter[618] /* powerBlock.ratio_m_des PARAM */);
  TRACE_POP
}
...
void sCO2PBRig_eqFunction_572(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  jacobian->tmpVars[0] /* powerBlock.reCompressor.m_des.$pDERLSJac49.dummyVarLSJac49 JACOBIAN_DIFF_VAR */ = (data->simulationInfo->realParameter[586] /* powerBlock.gamma PARAM */) * (jacobian->seedVars[0] /* powerBlock.LTR.m_turb_des.SeedLSJac49 SEED_VAR */);
  TRACE_POP
}
