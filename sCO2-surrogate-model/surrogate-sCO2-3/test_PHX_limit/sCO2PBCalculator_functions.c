...
#include "sCO2PBCalculator_functions.h"
#ifdef __cplusplus
extern "C" {
#endif

#include "sCO2PBCalculator_includes.h"
...
SolarTherm_Models_PowerBlocks_sCO2Cycle_DirectDesign__omcQuot_7265636F6D70504224706F776572426C6F636B_MedRec_ThermodynamicState omc_SolarTherm_Models_PowerBlocks_sCO2Cycle_DirectDesign__omcQuot_7265636F6D70504224706F776572426C6F636B_MedRec_ThermodynamicState(threadData_t *threadData, modelica_real omc_p, modelica_real omc_h)
{
  SolarTherm_Models_PowerBlocks_sCO2Cycle_DirectDesign__omcQuot_7265636F6D70504224706F776572426C6F636B_MedRec_ThermodynamicState tmp1;
  tmp1._p = omc_p;
  tmp1._h = omc_h;
  return tmp1;
}

modelica_metatype boxptr_SolarTherm_Models_PowerBlocks_sCO2Cycle_DirectDesign__omcQuot_7265636F6D70504224706F776572426C6F636B_MedRec_ThermodynamicState(threadData_t *threadData, modelica_metatype _p, modelica_metatype _h)
{
  return mmc_mk_box3(3, &SolarTherm_Models_PowerBlocks_sCO2Cycle_DirectDesign__omcQuot_7265636F6D70504224706F776572426C6F636B_MedRec_ThermodynamicState__desc, _p, _h);
}
