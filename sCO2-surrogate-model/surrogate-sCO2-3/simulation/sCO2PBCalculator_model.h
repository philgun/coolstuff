/* Simulation code for sCO2PBCalculator generated by the OpenModelica Compiler OpenModelica 1.15.0~dev-45-g634bc00. */
#if !defined(sCO2PBCalculator__MODEL_H)
#define sCO2PBCalculator__MODEL_H
...
#define SolarTherm_Models_PowerBlocks_sCO2Cycle_DirectDesign__omcQuot_7265636F6D70504224706F776572426C6F636B_MedRec_ThermodynamicState_index 71

extern void sCO2PBCalculator_callExternalObjectDestructors(DATA *_data, threadData_t *threadData);
#if !defined(OMC_NUM_NONLINEAR_SYSTEMS) || OMC_NUM_NONLINEAR_SYSTEMS>0
extern void sCO2PBCalculator_initialNonLinearSystem(int nNonLinearSystems, NONLINEAR_SYSTEM_DATA *data);
#endif
#if !defined(OMC_NUM_LINEAR_SYSTEMS) || OMC_NUM_LINEAR_SYSTEMS>0
extern void sCO2PBCalculator_initialLinearSystem(int nLinearSystems, LINEAR_SYSTEM_DATA *data);
#endif
#if !defined(OMC_NUM_MIXED_SYSTEMS) || OMC_NUM_MIXED_SYSTEMS>0
#endif
#if !defined(OMC_NO_STATESELECTION)
extern void sCO2PBCalculator_initializeStateSets(int nStateSets, STATE_SET_DATA* statesetData, DATA *data);
#endif
extern int sCO2PBCalculator_functionAlgebraics(DATA *data, threadData_t *threadData);
extern int sCO2PBCalculator_function_storeDelayed(DATA *data, threadData_t *threadData);
extern int sCO2PBCalculator_updateBoundVariableAttributes(DATA *data, threadData_t *threadData);
extern int sCO2PBCalculator_functionInitialEquations(DATA *data, threadData_t *threadData);
extern int sCO2PBCalculator_functionInitialEquations_lambda0(DATA *data, threadData_t *threadData);
extern int sCO2PBCalculator_functionRemovedInitialEquations(DATA *data, threadData_t *threadData);
extern int sCO2PBCalculator_updateBoundParameters(DATA *data, threadData_t *threadData);
extern int sCO2PBCalculator_checkForAsserts(DATA *data, threadData_t *threadData);
extern int sCO2PBCalculator_function_ZeroCrossingsEquations(DATA *data, threadData_t *threadData);
extern int sCO2PBCalculator_function_ZeroCrossings(DATA *data, threadData_t *threadData, double* gout);
extern int sCO2PBCalculator_function_updateRelations(DATA *data, threadData_t *threadData, int evalZeroCross);
extern const char* sCO2PBCalculator_zeroCrossingDescription(int i, int **out_EquationIndexes);
extern const char* sCO2PBCalculator_relationDescription(int i);
extern void sCO2PBCalculator_function_initSample(DATA *data, threadData_t *threadData);
extern int sCO2PBCalculator_initialAnalyticJacobianG(void* data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian);
extern int sCO2PBCalculator_initialAnalyticJacobianA(void* data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian);
extern int sCO2PBCalculator_initialAnalyticJacobianB(void* data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian);
extern int sCO2PBCalculator_initialAnalyticJacobianC(void* data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian);
extern int sCO2PBCalculator_initialAnalyticJacobianD(void* data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian);
extern int sCO2PBCalculator_initialAnalyticJacobianF(void* data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian);
extern int sCO2PBCalculator_functionJacG_column(void* data, threadData_t *threadData, ANALYTIC_JACOBIAN *thisJacobian, ANALYTIC_JACOBIAN *parentJacobian);
extern int sCO2PBCalculator_functionJacA_column(void* data, threadData_t *threadData, ANALYTIC_JACOBIAN *thisJacobian, ANALYTIC_JACOBIAN *parentJacobian);
extern int sCO2PBCalculator_functionJacB_column(void* data, threadData_t *threadData, ANALYTIC_JACOBIAN *thisJacobian, ANALYTIC_JACOBIAN *parentJacobian);
extern int sCO2PBCalculator_functionJacC_column(void* data, threadData_t *threadData, ANALYTIC_JACOBIAN *thisJacobian, ANALYTIC_JACOBIAN *parentJacobian);
extern int sCO2PBCalculator_functionJacD_column(void* data, threadData_t *threadData, ANALYTIC_JACOBIAN *thisJacobian, ANALYTIC_JACOBIAN *parentJacobian);
extern int sCO2PBCalculator_functionJacF_column(void* data, threadData_t *threadData, ANALYTIC_JACOBIAN *thisJacobian, ANALYTIC_JACOBIAN *parentJacobian);
extern const char* sCO2PBCalculator_linear_model_frame(void);
extern const char* sCO2PBCalculator_linear_model_datarecovery_frame(void);
extern int sCO2PBCalculator_mayer(DATA* data, modelica_real** res, short *);
extern int sCO2PBCalculator_lagrange(DATA* data, modelica_real** res, short *, short *);
extern int sCO2PBCalculator_pickUpBoundsForInputsInOptimization(DATA* data, modelica_real* min, modelica_real* max, modelica_real*nominal, modelica_boolean *useNominal, char ** name, modelica_real * start, modelica_real * startTimeOpt);
extern int sCO2PBCalculator_setInputData(DATA *data, const modelica_boolean file);
extern int sCO2PBCalculator_getTimeGrid(DATA *data, modelica_integer * nsi, modelica_real**t);
extern void sCO2PBCalculator_function_initSynchronous(DATA * data, threadData_t *threadData);
extern void sCO2PBCalculator_function_updateSynchronous(DATA * data, threadData_t *threadData, long i);
extern int sCO2PBCalculator_function_equationsSynchronous(DATA * data, threadData_t *threadData, long i);
extern void sCO2PBCalculator_read_input_fmu(MODEL_DATA* modelData, SIMULATION_INFO* simulationData);
extern void sCO2PBCalculator_function_savePreSynchronous(DATA *data, threadData_t *threadData);
extern int sCO2PBCalculator_inputNames(DATA* data, char ** names);
extern int sCO2PBCalculator_initializeDAEmodeData(DATA *data, DAEMODE_DATA*);
extern int sCO2PBCalculator_functionLocalKnownVars(DATA*, threadData_t*);
extern int sCO2PBCalculator_symbolicInlineSystem(DATA*, threadData_t*);

#include "sCO2PBCalculator_literals.h"
...
#endif /* !defined(sCO2PBCalculator__MODEL_H) */
