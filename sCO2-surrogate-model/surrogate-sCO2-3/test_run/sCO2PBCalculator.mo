...
model sCO2PBCalculator
  ...
  parameter SI.Power P_net = 25e6;
  parameter SI.Temperature T_in_ref_blk = 1153.2581652469908;
  parameter SI.AbsolutePressure p_high =  22485257.03508395 "high pressure of the cycle";
  parameter Real PR = 2.811301495421886 "Pressure ratio";
  parameter Modelica.SIunits.TemperatureDifference dTemp_HTF_PHX = 253.45681330590824 "T_in_ref_blk - T_cold_set";
  parameter Modelica.SIunits.TemperatureDifference delta = 101.57687054586354 "T_in_ref_blk - T_high";
  parameter SI.Temperature T_cold_set = T_in_ref_blk - dTemp_HTF_PHX;
  // *********************PB Params - Changeable Operation Param
  parameter Real load = 1;
  parameter SI.Temperature T_HTF_in = T_in_ref_blk;
  parameter SI.Temperature T_amb_input = 310.31;
