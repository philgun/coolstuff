...
//
  ...
  parameter SI.Power P_net = 67690794.6;
  parameter SI.Temperature T_in_ref_blk = 1098.81;
  parameter SI.AbsolutePressure p_high = 24315878.42 "high pressure of the cycle";
  parameter Real PR = 2.9 "Pressure ratio";
  parameter SI.Temperature T_cold_set = 828.61;
  parameter SI.Temperature delta = 77.53 "T_in_ref_blk - T_high";
  
  // *********************PB Params - Changeable Operation Param
  parameter Real load = 0.71;
  parameter SI.Temperature T_HTF_in = 1006.91;
  parameter SI.Temperature T_amb_input = 311.84;
