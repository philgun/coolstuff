...
extern void sCO2PBCalculator_Using_JPidea_eqFunction_1206(DATA* data, threadData_t *threadData);
extern void sCO2PBCalculator_Using_JPidea_eqFunction_1205(DATA* data, threadData_t *threadData);
extern void sCO2PBCalculator_Using_JPidea_eqFunction_1204(DATA* data, threadData_t *threadData);
...
int sCO2PBCalculator_Using_JPidea_functionAlgebraics(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
  ...
  sCO2PBCalculator_Using_JPidea_function_savePreSynchronous(data, threadData);
