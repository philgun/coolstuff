...
equation index: 26
type: SIMPLE_ASSIGN
powerBlock._C_generator = 18.07393377455308 * powerBlock.pri_generator
*/
void sCO2PBCalculator_Using_JPidea_eqFunction_26(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
  const int equationIndexes[2] = {1,26};
  data->simulationInfo->realParameter[33] /* powerBlock.C_generator PARAM */ = (18.07393377455308) * (data->simulationInfo->realParameter[617] /* powerBlock.pri_generator PARAM */);
  TRACE_POP
}
...
equation index: 92
type: SIMPLE_ASSIGN
powerBlock._cooler._P_cool_des = 4000000.0
*/
void sCO2PBCalculator_Using_JPidea_eqFunction_92(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
  const int equationIndexes[2] = {1,92};
  data->simulationInfo->realParameter[321] /* powerBlock.cooler.P_cool_des PARAM */ = 4000000.0;
  TRACE_POP
}
