...
extern void sCO2PBCalculator_Using_PinchPHX_eqFunction_1179(DATA* data, threadData_t *threadData);
...
extern void sCO2PBCalculator_Using_PinchPHX_eqFunction_1219(DATA* data, threadData_t *threadData);
extern void sCO2PBCalculator_Using_PinchPHX_eqFunction_1218(DATA* data, threadData_t *threadData);
extern void sCO2PBCalculator_Using_PinchPHX_eqFunction_1217(DATA* data, threadData_t *threadData);
...
int sCO2PBCalculator_Using_PinchPHX_functionAlgebraics(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
  ...
  sCO2PBCalculator_Using_PinchPHX_function_savePreSynchronous(data, threadData);
